...
3. After that the 0 number will be sum with the min number which is 4 so we get 4 at the least, if the number is 15 then after it get sum with the min number we get 19 which is the most we can get.
